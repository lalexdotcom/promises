...
const PROFILING_QUESTIONS = [
  ...
  },
  {
    ...
    question:
      'When the agent presents you with options, how do you typically decide?',
    options: [
      {
  ...
  },
  {
    ...
    question:
      'When something breaks, how do you typically approach debugging with the agent?',
    options: [
      {
      ...
      {
        label:
          'Share the error plus context, ask the agent to diagnose what went wrong',
        value: 'b',
        rating: 'diagnostic',
      },
      {
        label:
          'Investigate myself first, then ask the agent about my specific theories',
        value: 'c',
  ...
  },
  {
    ...
    options: [
      {
        label:
          'Use whatever the agent suggests -- speed matters more than the perfect choice',
        value: 'a',
  ...
  },
  {
    ...
    options: [
      ...
      {
        label: 'Ask the agent to explain the relevant parts to me',
        value: 'b',
        rating: 'guided',
      },
      {
