# Requirements Archive: v1.2 Balanced Enhancements
...
# v1.2 Requirements — Event-Driven Enhancements
...
- [ ] No promises made about features not in v1.2 (defer AsyncIterator, retry strategies to v2)
...
- [ ] No manual migration guide needed for v1.0→v1.2 (backward compatible, new features are opt-in)
...
- **Retry strategies** — out of scope for v1.2; recommend user-side retry loops for now
