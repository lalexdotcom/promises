...
- ✅ **v1.2 — Balanced Enhancements** ([Archived](milestones/v1.2-ROADMAP.md)) — Shipped 2026-03-24
- 📋 **v1.3 — (Planned)**

---

<details>
<summary>✅ v1.2 — Balanced Enhancements (Phases 5–9) — SHIPPED 2026-03-24</summary>
...
*(Planning v1.3 not yet started — define scope with `/gsd-new-milestone`)*
...
**Updated:** 2026-03-24 — v1.2 milestone archived, ready for v1.2 planning
